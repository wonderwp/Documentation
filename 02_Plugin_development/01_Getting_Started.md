...
If you do not feel like using the command line, you can follow the following steps by hand.\
The idea is to manually create the [plugin architecture](broken-reference).\
...
* [Plugin architecture](../src/02_Creating_a_plugin/03_Plugin_architecture/)
* [Plugin services](../src/02_Creating_a_plugin/04_Services/)
* [Framework capabilities](../src/03_Framewok_components/)
