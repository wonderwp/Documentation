...
* [**Using the CLI Generator**](block-types.md#using-the-generator) (Automated)
* [**Using AI Rules**](block-types.md#using-ai) (Agentic & Dynamic)
* [**Class-Based Approach**](block-types.md#class-based) (Object-Oriented)
* [**Flat File Approach**](block-types.md#flat-file-based) (Procedural)
...
🔹 _This method gives you complete freedom to declare Block Types the way you normally would in WordPress._
