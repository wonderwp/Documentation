...
* The `WpCliLogger` class, which delegated all its logging method to corresponding [WP\_CLI](https://make.wordpress.org/cli/handbook/references/internal-api/wp-cli-log/) ones
